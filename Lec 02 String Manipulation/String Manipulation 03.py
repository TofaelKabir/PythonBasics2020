...
m = "My Name Is Manir"  # "My Game is Gonir"

print("replace():", m.replace("Ma", "G"))  # will replace all M to G
...
sentence1 = "The phone number {1} belongs to Sohag. His age is {0}"
print(sentence1.format(age, phone))
...
# text = "The team \"Barcelona\" is my favorite"
# print(text)
